...
export default function WeddingDetails() {
    ...
    return (
        <>
            <Helmet>
                <title>Best Corporate Pool Party Venue in Patna | Jungle Resort</title>

                <meta
                    name="description"
                    content="Enjoy corporate pool party at Jungle Resort Patna with DJ, rain dance, pool fun & team activities. Book best pool party venue today!"
                />

                <meta
                    name="keywords"
                    content="Corporate pool party Patna, Pool party venue Patna, Rain dance Patna, Jungle Resort pool party"
                />
                ...
                {/* CANONICAL */}
                <link rel="canonical" href="https://jungleresortpatna.in/corporatepoolparty" />
                    ...
                    {`
{
  ...
  "description": "Best corporate pool party venue in Patna with DJ, rain dance & water fun at Jungle Resort."
}
`}
                </script>
            </Helmet>
                    ...
                    <div className={styles.heroContent}>
                        ...
                        <div className={styles.heroLeft}>
                            <h1 className={styles.heroTitle}>
                                Best <span>Corporate Pool Party</span> Venue in Patna
                            </h1>
                        </div>
                    ...
                    <div className={styles.galleryGrid}>
                        ...
                        {media.map((item, i) => (
                            ...
                            >
                                ...
                                {item.type === "image" ? (
                                    <>
                                        <img src={item.url} alt="Corporate Pool Party Jungle Resort Patna" className={styles.galleryImage} />
                                    ...
                                    <>
                                        <img
                                            ...
                                            alt="Corporate Pool Party Jungle Resort Patna"
                    ...
                    <div className={styles.galleryViewer} onClick={() => setSelectedIndex(null)}>
                        ...
                        >
                            ...
                            {selectedMedia.type === "image" ? (
                                <img src={selectedMedia.url} className={styles.galleryFullImage} alt="Corporate Pool Party Jungle Resort Patna" />
                            ) : (
                                <iframe
