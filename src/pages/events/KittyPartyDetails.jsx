...
export default function WeddingDetails() {
    ...
    return (
        <>
            <Helmet>
                <title>Best Kitty Party Venue in Patna | Jungle Resort</title>

                <meta
                    name="description"
                    content="Enjoy fun and stylish kitty parties at Jungle Resort Patna with DJ, pool, games & luxury setup. Book best kitty party venue today!"
                />

                <meta
                    name="keywords"
                    content="Kitty party Patna, Kitty party venue Patna, Ladies party Patna, Jungle Resort kitty party"
                />
                ...
                {/* CANONICAL */}
                <link rel="canonical" href="https://jungleresortpatna.in/kittyparty" />
                    ...
                    {`
{
  ...
  "description": "Best kitty party venue in Patna with DJ, pool & fun activities at Jungle Resort."
}
`}
                </script>
            </Helmet>
                    ...
                    <div className={styles.heroContent}>
                        ...
                        <div className={styles.heroLeft}>
                            <h1 className={styles.heroTitle}>
                                Best <span>Kitty Party</span> Venue in Patna
                            </h1>
                        </div>

                        <div className={styles.heroRight}>
                            <QuickBookForm defaultFunctionType="Kitty Party" />
                        </div>
                    </div>
                </section>
                    ...
                    <div className={styles.galleryGrid}>
                        ...
                        {media.map((item, i) => (
                            ...
                            >
                                ...
                                {item.type === "image" ? (
                                    <>
                                        <img src={item.url} alt="Kitty Party Jungle Resort Patna" className={styles.galleryImage} />
                                    ...
                                    <>
                                        <img
                                            ...
                                            alt="Kitty Party Jungle Resort Patna"
                    ...
                    <div className={styles.galleryViewer} onClick={() => setSelectedIndex(null)}>
                        ...
                        >
                            ...
                            {selectedMedia.type === "image" ? (
                                <img src={selectedMedia.url} className={styles.galleryFullImage} alt="Kitty Party Jungle Resort Patna" />
                            ) : (
                                <iframe
