...
export const WATERPARK_TICKETS = [
    { id: "kidsbelow10years", name: "Kids (Below 10 Yrs)", price: 0, originalPrice: 499, features: ["Wave Pool", "Rain Dance", "DJ", "Water Slides"] },
    { id: "above10years", name: "Adult (Above 10 Yrs)", price: 199, originalPrice: 549, features: ["Wave Pool", "Rain Dance", "DJ", "Water Slides"] },
...
export const WATERPARK_ADDONS = [
    { id: "wpaKids", name: "Kids (Below 10 Yrs)", price: 0, emoji: "👶" },
    { id: "wpaAdult", name: "Adult (Above 10 Yrs)", price: 199, emoji: "🧑" },
